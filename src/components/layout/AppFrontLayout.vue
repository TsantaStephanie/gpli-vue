    ...
    <header class="front-header">
      ...
      <div class="header-left">
        <router-link to="/front/tickets" class="logo" tabindex="-1">
          ...
          <span class="logo-tag">portail</span>
        </router-link>
      </div>

      <!-- Centre : navigation -->
      <nav class="front-nav" aria-label="Navigation principale">
        <!-- <router-link to="/front/tickets" class="nav-link" active-class="nav-active">
      ...
      <div class="header-right">
        ...
        <router-link to="/front/tickets/create" class="btn-create">
